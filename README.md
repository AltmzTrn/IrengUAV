...
## Current Version
Currently, the primary active development branch of this firmware focuses on a sub-100g brushed quadcopter utilizing an STM32F103C8T6 as the main flight controller.  
